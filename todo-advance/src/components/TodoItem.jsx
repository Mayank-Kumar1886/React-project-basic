  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`shrink-0 w-6 h-6 rounded-lg flex items-center justify-center transition-all duration-300 transform hover:scale-110 active:scale-95 ${
          todo.completed
            ? "bg-gradient-to-br from-emerald-400 to-teal-500 border-emerald-400 shadow-lg shadow-emerald-400/50"
            : "border border-white/30 hover:border-violet-400 hover:bg-violet-500/20"
        }`}
      >
        {todo.completed && (
